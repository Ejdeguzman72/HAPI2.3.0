 ...
 */
package com.deguzman.hapi2_2_0.menu_vehicle_mods;
 ...
 * @author ejdeg
 */
public class VehicleModsMenu extends javax.swing.JFrame {

    /**
     * Creates new form MainMenu
     */
    public VehicleModsMenu() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("View Vehicle Mods Information: Display vehicle mods information that is \nregistered in the database. Relevant information includes manufacturer,\nmodel, year, quantity, nd vehicle that it is associated with. \n\n");
        ...
        jTextArea3.setText("Add Vehicle Mods Information: Simple form that allows the user to add \nvehicle information. User must submit the correct information in \nthe form. ");
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        // TODO add your handling code here:
        VehicleModsMenu vehicleMenu = new VehicleModsMenu();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VehicleModsMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VehicleModsMenu().setVisible(true);
            }
        });
    }
